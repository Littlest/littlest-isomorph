 ...
 *      instantiating `component`. The Action may return a Promise if it
 *      depends on asynchronous behaviour to complete.
 */
...
Router.prototype._mapRoutrRoute = function _mapRoutrRoute(route, options) {
  ...
  return {
    ...
    component: route.component || route.config && route.config.component,
